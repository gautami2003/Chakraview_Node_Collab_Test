                    ...
                    <div className="container-fluid px-4">
                        ...
                        <div className="row">
                            <div className="col-xl-6 grid-margin card-people">
                                ...
                                {/* <Image className="img-fluid pr10" src={DashboardImage} alt="Dashboard Image" /> */}
                            </div>
                                    ...
                                    <div className="col-md-6">
                                        <div className="card text-center border-0 bg-pr-one text-white mb-4">
                                            <div className="card-body d-flex align-items-center justify-content-between">
                                                <a className="xx-large text-white stretched-link" href="#">BusOperators</a>
                                                <div className="xx-large text-white"><i className="fas fa-users"></i></div>
                                            </div>
                                            <div className="card-footer text-center">
                                                {/* <h1>166</h1> */}
                                                <h1>{dashboard?.busOperators || 0}</h1>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-md-6">
                                        <div className="card bg-pr-two border-0 text-white mb-4">
                                            <div className="card-body d-flex align-items-center justify-content-between">
                                                <a className="xx-large text-white stretched-link" href="#">Schools</a>
                                                <div className="xx-large text-white"><i className="fas fa-calendar"></i></div>
                                            </div>
                                            <div className="card-footer text-center">
                                                {/* <h1>150</h1> */}
                                                <h1>{dashboard?.schools || 0}</h1>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className="row">
                                    ...
                                    <div className="col-md-6">
                                        <div className="card bg-pr-four border-0 text-white mb-4">
                                            ...
                                            <div className="card-footer text-center">
                                                {/* <h1>5.7k</h1> */}
                                                <h1>{dashboard?.sent_notification || 0}</h1>
                                            </div>
                                        </div>
                                    </div>
                                </div>
