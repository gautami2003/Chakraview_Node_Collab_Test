    ...
    useEffect(() => {
        try {
            ...
            const getDropRoute = async () => {
                const result = await axios.get(`${process.env.NEXT_PUBLIC_API_URL}/drop-route-master`,
                    {
                        headers: {
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div className="container-fluid px-4 mt-5">
                        <h2 className="text-center font-weight-light my-4"><b>Drop Route</b></h2>
                                            ...
                                            {dropRoute.map((data, index) => {
                                                return (
                                                    <tr key={index}>
                                                        ...
                                                        <td>
                                                            <Tooltip targetId={`edit-${data.pickupRouteID}`} position="top" text="Edit Drop Route" />
                                                            ...
                                                            <Tooltip targetId={`delete-${data.pickupRouteID}`} position="top" text="Delete Drop Route" />
...
export default DropRouteContent;
